...
public static class DialogHelper
{
    ...
    public static void ReturnResultFromOverlayDialog(this IDialogParticipant? context, object? result)
    {
        ...
        var overlayDialog = DialogManager.GetVisualForContext(context).
                FindAncestorOfType<OverlayDialog>(includeSelf: true);

        if (overlayDialog is null) throw new InvalidOperationException("Unable to find OverlayDialog");
