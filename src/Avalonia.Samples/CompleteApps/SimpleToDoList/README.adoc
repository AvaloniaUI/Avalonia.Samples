...
TIP: When you create a new project from the IDE you can choose the MVVM package you prefer. If you didn't choose the `CommunityToolkit.MVVM`-package, you may need to install `CommunityToolkit.MVVM` via NuGet to be able to use the source generators in this tutorial.
