...
Inside your `Models` folder, add a new file `ToDoItem.cs`. This is the class file for the `ToDoItem` class, which has two properties. This model is used to save and restore the user's ToDo list.
