...
Lastly, the view model needs a way to get the updated model back, if the user makes changes to it. We can use a read-only property or a method like the one shown below:
