...
=== Prepare your IDE
Please make sure you have setup your IDE according to the [https://docs.avaloniaui.net/docs/getting-started/ide-support[docs,window=_blank]]. Moreover you should have read the [https://docs.avaloniaui.net/docs/getting-started[Getting Started guide,window=_blank]]. 
...
- https://docs.avaloniaui.net/docs/getting-started/programming-with-avalonia/the-model-view-viewmodel-pattern-mvvm[[Avalonia Docs\],window=_blank]
...
Avalonia uses `Controls` to represent functional components of a GUI Layout.  Example `Controls` include [https://docs.avaloniaui.net/docs/controls/scrollbar[`ScrollBar`,window=_blank]], [https://docs.avaloniaui.net/docs/controls/button[`Button`,window=_blank]], and [https://docs.avaloniaui.net/docs/controls/textbox[`TextBox`,window=_blank]]. `Properties` (like the `Text`-property of a `TextBox`) describe and allow interation with the `Controls`.
...
- https://docs.avaloniaui.net/tutorials/todo-list-app[[ToDo List App\],window=_blank]
- https://docs.avaloniaui.net/tutorials/music-store-app[[Music Store App\],window=_blank]
