...
NOTE: The `NumericUpDown` control works best with `decimal` or `decimal` values as these can store exact numbers. https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/builtin-types/floating-point-numeric-types[[more about it\]]
