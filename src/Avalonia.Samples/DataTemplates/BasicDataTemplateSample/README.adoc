...
If you don't want to use `Resources` for the reused parts, you can also create a https://docs.avaloniaui.net/controls/primitives/usercontrol[[`UserControl`\]] for it.  
